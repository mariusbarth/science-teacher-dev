...
Anders ausgedrückt, wir stehen wieder einmal vor dem Problem, einen möglichen Fehler im wissenschaftlichen Erkennisprozess zu begehn, nämlich den *Fehler nicht berücksichtigter Drittvariablen*.
...
Die statistische Kontrolle von Drittvariablen ist z.B. im Rahmen der Regression leicht möglich, indem man sie als weitere Prädiktorvariablen in die Regressionsgleichung mit aufnimmt.
...
Dittens kann es sein, dass wir ein Merkmal zawr miterheben und statistisch kontrollieren; erinnern wir uns aber daran, dass praktische jede Messung mit einem bestimmten Messfehler behaftet ist und manche Merkmale gar nicht direkt sondern nur indirekt messbar sind, besteht auch das Problem, dass wir denken, den Einfluss eines Merkmals statistisch zu kontrollieren, aber augrund unseres Messfehlers messen wir das Merkmal so schlecht, dass wir seinen Einfluss nicht vollständig statistisch kontrollieren können.
