...
out <- apa_barplot(data = agg, dv = "Admitted", id = "id", factors = "Gender", las = 1, args_error_bars = list(lwd = 0), args_rect = theme)
```
...
Die Autoren fanden sogar einen sehr kleinen Effekt, dass Frauen geringfügig "bevorzugt" wurden -- es sich also um 
einen Fall von Simpsons Paradox handelt.
