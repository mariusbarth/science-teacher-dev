...
```{r popper-swane, fig.margin = TRUE, fig.cap = "Nur weil man viele weiße Schwäne gesehen hat, kann man nicht behaupten, dass alle Schwäne weiß sind."}
...
führe letzlich zu wissenschaftlichem Fortschritt.
